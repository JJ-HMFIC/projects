...
from schema.request import SignUpRequest, LogInRequest, CreateOTPRequest, VerifyOTPReqeust
...
def user_log_in_handler(
    ...
    # 1. request body(username, password)
    # 2. db read user
    user: User = user_repo.get_user_by_username(
